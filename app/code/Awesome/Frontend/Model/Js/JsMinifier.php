...
/**
 * Class JsMinify
 * Based on https://github.com/tedious/JShrink
 */
class JsMinifier
{
    /**
     ...
     */
    private $stringDelimiters = ['\'' => true, '"' => true, '`' => true];

    /**
     * Contains the default options for minification. This array is merged with
     * the one passed in by the user to create the request specific set of options (stored in the $options attribute).
     * @var array $defaultOptions
     */
    private $defaultOptions = ['flaggedComments' => true];
     ...
     * @var array $noNewLineCharacters
     */
    private $noNewLineCharacters = [
        '(' => true,
        '-' => true,
        '+' => true,
        '[' => true,
     ...
     * @return void
     */
    private function minifyDirectToOutput(string $js, array $options): void
    {
     ...
     * @return void
     */
    private function initialize(string $js, array $options): void
    {
    ...
    private function getChar()
    {
        ...
        if (isset($this->c)) {
            ...
            $char = $this->index < $this->length ? $this->input[$this->index] : false;
     ...
     *
     *
     * @return string|false      Next 'real' character to be processed.
     ...
     * @return void
     */
    private function processOneLineComments(int $startIndex): void
    {
        $thirdCommentString = $this->index < $this->length ? $this->input[$this->index] : false;
     ...
     */
    private function processMultiLineComments(int $startIndex): void
    {
     ...
     */
    private function getNext(string $string)
    {
        ...
        return $this->index < $this->length ? $this->input[$this->index] : false;
    }
     ...
     */
    private function saveRegex(): void
    {
        echo $this->a . $this->b;
     ...
     * @return string
     */
    private function unlock(string $js): string
    {
        if (empty($this->locks)) {
            return $js;
        }
