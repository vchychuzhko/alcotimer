...
use Awesome\Frontend\Model\Css\Minify\Colors;
use Awesome\Frontend\Model\Css\Minify\Utils;

/**
 * Class CssMinify
 * Based on https://github.com/tubalmartin/YUI-CSS-compressor-PHP-port
 */
class CssMinifier
{
    private const QUERY_FRACTION = '_CSSMIN_QF_';
    private const COMMENT_TOKEN = '_CSSMIN_CMT_%d_';
    private const COMMENT_TOKEN_START = '_CSSMIN_CMT_';
    private const RULE_BODY_TOKEN = '_CSSMIN_RBT_%d_';
    private const PRESERVED_TOKEN = '_CSSMIN_PTK_%d_';
     ...
     */
    private function registerRuleBodyToken(string $body): string
    {
        if (empty($body)) {
            return '';
        }
     ...
     * @return string
     */
    private function process(string $css): string
    {
        // Process data urls
     ...
     * @return string
     */
    private function processDataUrls(string $css): string
    {
        $ret = '';
     ...
     * @return string
     */
    private function processComments(string $css): string
    {
     ...
     * @return string
     */
    private function processRuleBodies(string $css): string
    {
        $ret = '';
        $searchOffset = $substrOffset = 0;
     ...
     * @return string
     */
    private function processRuleBody(string $body): string
    {
        $body = trim($body);
     ...
     * @return string
     */
    private function processAtRulesAndSelectors(string $css): string
    {
        $charset = '';
        $imports = '';
        $namespaces = '';
     ...
     * @return string
     */
    private function processLongLineSplitting(string $css): string
    {
