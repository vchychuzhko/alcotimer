...
namespace Vch\Frontend\Model\XmlParser;

use Vch\Framework\Exception\XmlValidationException;
use Vch\Framework\Helper\DataHelper;
use Vch\Framework\Helper\XmlParsingHelper;
use Vch\Framework\Model\Config;
use Vch\Framework\Model\FileManager\XmlFileManager;
use Vch\Frontend\Block\Container;
use Vch\Frontend\Block\Html\Body;
use Vch\Frontend\Block\Html\Head;
use Vch\Frontend\Block\Root;

class LayoutXmlParser extends \Vch\Framework\Model\AbstractXmlParser
{
    private const DEFAULT_HANDLE_NAME = 'default';
    private const LAYOUT_XML_PATH_PATTERN = '/*/*/view/%s/layout/%s.xml';
    private const LAYOUT_XSD_SCHEMA_PATH = '/Vch/Frontend/Schema/page_layout.xsd';
