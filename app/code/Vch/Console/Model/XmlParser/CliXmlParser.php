...
namespace Vch\Console\Model\XmlParser;

use Vch\Framework\Exception\XmlValidationException;

class CliXmlParser extends \Vch\Framework\Model\AbstractXmlParser
{
    private const CLI_XML_PATH_PATTERN = '/*/*/etc/cli.xml';
    private const CLI_XSD_SCHEMA_PATH = '/Vch/Console/Schema/cli.xsd';
